...
public class CalculadoraGUI extends Frame implements ActionListener {
    ...
    public void bottomPanel() {
        ...
        buttonPoint.setBackground(new Color(160, 160, 160));
        buttonEqual.setBackground(new Color(160, 160, 160));
        buttonPercentage.setBackground(new Color(160, 160, 160));
        buttonAllClear.setBackground(new Color(160, 160, 160));
        buttonDelete.setBackground(new Color(160, 160, 160));
        buttonScuareRoot.setBackground(new Color(160, 160, 160));
        buttonDivision.setBackground(new Color(160, 160, 160));
        buttonMultiplication.setBackground(new Color(160, 160, 160));
        buttonAdd.setBackground(new Color(160, 160, 160));
        buttonSubtract.setBackground(new Color(160, 160, 160));

        buttonAllClear.setBackground(new Color(204, 102, 0));
        buttonDelete.setBackground(new Color(204, 102, 0));
    ...
    public Button button(Button buttonType) {
        buttonType.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) {
                buttonType.setBackground(Color.decode("#FFFFFF"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // ImplementaciÃ³n de botones de operaciones

        // ImplementaciÃ³n para aÃ±adir un solo punto
        // MÃ©todo que distingue si existe un punto, solo sea aquel que este en la
        // operaciÃ³n
